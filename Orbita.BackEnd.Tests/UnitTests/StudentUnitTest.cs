...
namespace Orbita.BackEnd.Tests.UnitTests
{
    public class StudentUnitTest
    {
        ...
        [Fact]
        public void CreateStudent_WithInvalidCPFLenght_ShouldBeInvalid()
        {
        ...
        [Fact]
        public void CreateStudent_WithInvalidCPFWithLetters_ShouldBeInvalid()
        {
            var student = new Student { Name = "Raissa Gonçalves", CPF = "10987as3211", Email = "hellothisisnotaemail", RA = "24023214" };
